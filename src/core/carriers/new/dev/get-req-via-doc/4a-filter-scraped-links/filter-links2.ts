...
export const filterLinks2 = (
  ...
  const linksDirPath = `./src/core/carriers/new/dev/get-req-via-doc/3-scrape-links/scraped-links/${formattedServiceName}`;
  const outputDirPath = `./src/core/carriers/new/dev/get-req-via-doc/4a-filter-scraped-links/filtered-links/${formattedServiceName}`;
