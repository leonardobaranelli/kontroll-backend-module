...
export const filterLinks = (
  ...
  const linksFilePath = `./src/core/carriers/new/dev/get-req-via-doc/1-scrape-site/links/all_links_${formattedServiceName}.json`;
  const outputFilePath = `./src/core/carriers/new/dev/get-req-via-doc/2-filter-scraped-site/filtered-links/filtered_links_${formattedServiceName}.json`;
