...
export const filterLinks2 = (
  ...
  const linksDirPath = `./src/core/carriers/create-by-steps/new/dev-get-req-via-doc/automated-system/3-scrape-links/scraped-links/${formattedServiceName}`;
  const outputDirPath = `./src/core/carriers/create-by-steps/new/dev-get-req-via-doc/automated-system/4a-filter-scraped-links/filtered-links/${formattedServiceName}`;
