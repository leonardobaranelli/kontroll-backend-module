...
export const filterLinks = (
  ...
  const linksFilePath = `./src/core/carriers/create-by-steps/new/dev-get-req-via-doc/automated-system/1-scrape-site/links/all_links_${formattedServiceName}.json`;
  const outputFilePath = `./src/core/carriers/create-by-steps/new/dev-get-req-via-doc/automated-system/2-filter-scraped-site/filtered-links/filtered_links_${formattedServiceName}.json`;
